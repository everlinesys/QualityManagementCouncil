        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-left">
            ...
            <div className="mt-10 pt-6 border-t border-slate-100 flex gap-8">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-black text-slate-900">ISO 20700</span>
          ...
          {/* RIGHT VISUAL: COMPACT TRUST GRID */}
          <div className="hidden lg:grid grid-cols-2 gap-3 relative">
            ...
            <div className="bg-slate-50 p-6 rounded-lg border border-slate-200 flex flex-col items-center text-center translate-y-4">
            ...
            <div className="bg-slate-900 p-6 rounded-lg flex flex-col items-center text-center text-white translate-y-4 shadow-xl shadow-slate-200">
