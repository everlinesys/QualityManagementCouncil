      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row gap-12 items-start">
          ...
          <div className="w-full md:w-1/3 space-y-6">
            ...
            {/* 🔥 NEW: Government Image */}
            <div className="relative rounded-lg overflow-hidden border border-slate-200">
              <img 
                src="/govt.jpeg" 
                alt="Government Authority"
                className="w-full h-32 object-cover grayscale hover:grayscale-0 transition duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" />
              <span className="absolute bottom-2 left-3 text-[10px] text-white font-bold uppercase tracking-wider">
